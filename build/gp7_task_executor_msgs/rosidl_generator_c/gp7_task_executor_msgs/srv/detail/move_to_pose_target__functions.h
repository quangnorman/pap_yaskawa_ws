...
#ifndef GP7_TASK_EXECUTOR_MSGS__SRV__DETAIL__MOVE_TO_POSE_TARGET__FUNCTIONS_H_
#define GP7_TASK_EXECUTOR_MSGS__SRV__DETAIL__MOVE_TO_POSE_TARGET__FUNCTIONS_H_
...
/// Initialize srv/MoveToPoseTarget message.
/**
...
/// Finalize srv/MoveToPoseTarget message.
/**
...
/// Create srv/MoveToPoseTarget message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Request__init().
...
/// Destroy srv/MoveToPoseTarget message.
/**
 * It calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Request__fini()
...
/// Check for srv/MoveToPoseTarget message equality.
/**
...
/// Copy a srv/MoveToPoseTarget message.
/**
...
/// Initialize array of srv/MoveToPoseTarget messages.
/**
...
/// Finalize array of srv/MoveToPoseTarget messages.
/**
 * It calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Request__fini()
...
/// Create array of srv/MoveToPoseTarget messages.
/**
 * It allocates the memory for the array and calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveToPoseTarget messages.
/**
 * It calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveToPoseTarget message array equality.
/**
...
/// Copy an array of srv/MoveToPoseTarget messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gp7_task_executor_msgs
...
/**
 * It calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gp7_task_executor_msgs
...
/**
 * It allocates the memory for the array and calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gp7_task_executor_msgs
...
/**
 * It calls
 * gp7_task_executor_msgs__srv__MoveToPoseTarget_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GP7_TASK_EXECUTOR_MSGS__SRV__DETAIL__MOVE_TO_POSE_TARGET__FUNCTIONS_H_
