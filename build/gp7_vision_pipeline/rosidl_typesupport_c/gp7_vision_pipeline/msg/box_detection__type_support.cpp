...
static const _BoxDetection_type_support_symbol_names_t _BoxDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gp7_vision_pipeline, msg, BoxDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gp7_vision_pipeline, msg, BoxDetection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gp7_vision_pipeline, msg, BoxDetection)() {
  return &::gp7_vision_pipeline::msg::rosidl_typesupport_c::BoxDetection_message_type_support_handle;
}
