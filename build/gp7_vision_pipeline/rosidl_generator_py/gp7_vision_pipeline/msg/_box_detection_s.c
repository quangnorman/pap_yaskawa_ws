...
bool gp7_vision_pipeline__msg__box_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gp7_vision_pipeline.msg._box_detection.BoxDetection", full_classname_dest, 51) == 0);
  }
  gp7_vision_pipeline__msg__BoxDetection * ros_message = _ros_message;
  {  // header
  ...
  {  // width_px
    PyObject * field = PyObject_GetAttrString(_pymsg, "width_px");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->width_px = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // height_px
    PyObject * field = PyObject_GetAttrString(_pymsg, "height_px");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->height_px = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // distance_m
...
{
  /* NOTE(esteve): Call constructor of BoxDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gp7_vision_pipeline.msg._box_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoxDetection");
  ...
  {  // width_px
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->width_px);
    {
      int rc = PyObject_SetAttrString(_pymessage, "width_px", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // height_px
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->height_px);
    {
      int rc = PyObject_SetAttrString(_pymessage, "height_px", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
